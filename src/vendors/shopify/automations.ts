      ...
      templateBuilder: (config: VendorConsumerConfig) =>
        createOrderConfirmationEmail({
          ...
          fieldNames: {
            ...
            itemUnitPrice: SHOPIFY_FIELDS.itemUnitPrice,
            itemTotal: SHOPIFY_FIELDS.itemTotal,
          },
        }),
    },
    {
      ...
      templateBuilder: (config: VendorConsumerConfig) =>
        createShippingUpdateEmail({
          ...
          footer: config.footer,
          text: {
            ...SHIPPING_UPDATE_TEXT,
            returnPolicyUrl: config.websiteUrl + '/return-policy',
            termsUrl: config.websiteUrl + '/terms',
          },
          fieldNames: {
            firstName: SHOPIFY_FIELDS.customerFirstName,
            orderRef: SHOPIFY_FIELDS.orderRef,
            ...
            // Receipt fields
            customerFullName: SHOPIFY_FIELDS.customerFullName,
            customerEmail: SHOPIFY_FIELDS.customerEmail,
            orderDate: SHOPIFY_FIELDS.orderDate,
            billingAddress: SHOPIFY_FIELDS.billingAddress,
            companyName: SHOPIFY_FIELDS.companyName,
            vatNumber: SHOPIFY_FIELDS.vatNumber,
            paymentMethod: SHOPIFY_FIELDS.paymentMethod,
            currency: SHOPIFY_FIELDS.currency,
            subtotal: SHOPIFY_FIELDS.subtotal,
            taxAmount: SHOPIFY_FIELDS.taxAmount,
            discountAmount: SHOPIFY_FIELDS.discountAmount,
            shippingCost: SHOPIFY_FIELDS.shippingCost,
            shippingAddress: SHOPIFY_FIELDS.shippingAddress,
            shippingCarrier: SHOPIFY_FIELDS.shippingCarrier,
            totalPrice: SHOPIFY_FIELDS.totalPrice,
            items: SHOPIFY_FIELDS.items,
            itemName: SHOPIFY_FIELDS.itemName,
            itemQuantity: SHOPIFY_FIELDS.itemQuantity,
