...
import type { VendorAutomation, VendorConsumerConfig } from '../types.js';
import type { RCMLDocument, RCMLBodyChild } from '../../types/index.js';
import type { CustomFieldMap, FooterConfig } from '../../rcml/index.js';
