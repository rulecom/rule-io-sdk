...
import type { RCMLAttributes, RCMLBodyChild, RCMLButton, RCMLColumn, RCMLColumnChild, RCMLDocument, RCMLHead, RCMLHeading, RCMLProseMirrorDoc, RCMLLoop, RCMLSection, RCMLText } from '../types/index.js';
 ...
 * ```
 */
export function toBrandStyleConfig(data: import('../types/index.js').RuleBrandStyle): BrandStyleConfig {
...
export interface BrandStyleResolverClient {
  listBrandStyles(): Promise<import('../types/index.js').RuleBrandStyleListResponse>;
  getBrandStyle(
    brandStyleId: number,
  ): Promise<import('../types/index.js').RuleBrandStyleResponse | null>;
}
