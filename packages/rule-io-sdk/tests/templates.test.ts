...
import type { BrandStyleConfig, CustomFieldMap } from '../src/rcml/index.js';
import { RuleConfigError } from '../src/errors.js';
import { validateCustomFields, toBrandStyleConfig, resolvePreferredBrandStyle, withTemplateContext, createStatusTrackerSection } from '../src/rcml/brand-template.js';
import type { BrandStyleResolverClient } from '../src/rcml/brand-template.js';
import type {
  RuleBrandStyle,
...
describe('barrel exports', () => {
  it('should export validateCustomFields from the barrel', async () => {
    const barrel = await import('../src/rcml/index.js');
