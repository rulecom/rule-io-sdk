...
describe('TagsClient', () => {
  ...
  describe('get dispatcher', () => {
    it('dispatches to getById when identifier is a number', async () => {
      ...
      expect(fetchMock.mock.calls[0]![0] as string).toBe('https://app.rule.io/api/v2/tags/1?identified_by=id');
    });
    ...
    it('dispatches to getByName when identifier is a string', async () => {
      ...
      expect(fetchMock.mock.calls[0]![0] as string).toBe('https://app.rule.io/api/v2/tags/Newsletter?identified_by=name');
    });
  });
  ...
  describe('clear dispatcher', () => {
    it('dispatches to clearById when identifier is a number', async () => {
      ...
      expect(fetchMock.mock.calls[0]![0] as string).toBe('https://app.rule.io/api/v2/tags/1/clear?identified_by=id');
    });
    ...
    it('dispatches to clearByName when identifier is a string', async () => {
      ...
      expect(fetchMock.mock.calls[0]![0] as string).toBe('https://app.rule.io/api/v2/tags/Newsletter/clear?identified_by=name');
    });
  });
});
