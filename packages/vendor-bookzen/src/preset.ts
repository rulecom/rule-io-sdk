...
//
//   for (const [logicalName, fieldName] of Object.entries(BOOKZEN_FIELD_SCHEMA)) {
...
//     return Object.entries(BOOKZEN_FIELD_SCHEMA).map(([logicalName, fieldName]) => ({
//       logicalName,
//       fieldName,
//       description: FIELD_DESCRIPTIONS[logicalName as BookzenFieldName],
//     }));
//   },
// };
